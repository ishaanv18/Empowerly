                ...
                <nav className="sidebar-nav">
                    ...
                    {(user?.role === 'EMPLOYEE' || user?.role === 'HR' || user?.role === 'ADMIN') && (
                        <>
                            <button
                                className="nav-item"
                                onClick={() => handleNavigation(`/dashboard/${user?.role?.toLowerCase()}`, 'attendance')}
                            >
                                <span className="nav-icon">📅</span>
                            ...
                            <button
                                className="nav-item"
                                onClick={() => handleNavigation(`/dashboard/${user?.role?.toLowerCase()}`, 'leaves')}
                            >
                                <span className="nav-icon">🌴</span>
                                <span>Leaves</span>
                            </button>
                            ...
                            <button
                                className="nav-item"
                                onClick={() => handleNavigation(`/dashboard/${user?.role?.toLowerCase()}`, 'chat')}
                            >
                                <span className="nav-icon">💬</span>
                                <span>Chat</span>
                            </button>
                            ...
                            <button
                                className="nav-item"
                                onClick={() => handleNavigation(`/dashboard/${user?.role?.toLowerCase()}`, 'meetings')}
                            >
                                <span className="nav-icon">📹</span>
                                <span>Meetings</span>
                            </button>
                    ...
                    {/* Security & Audit Section - HR/Admin */}
                    {(user?.role === 'HR' || user?.role === 'ADMIN') && (
                        <div className="nav-section">
                            ...
                            <button
                                className="nav-item"
                                onClick={() => handleNavigation('/dashboard/audit-logs', 'audit-logs')}
                            >
