...
export const auditLogAPI = {
    ...
    getUserActivityLogs: (userId, params) => api.get(`/audit-logs/user/${userId}`, { params }),
    getEntityAuditTrail: (entityType, entityId) => api.get(`/audit-logs/entity/${entityType}/${entityId}`),
