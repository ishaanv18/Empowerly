...
import heroVideo from '../assets/videos/Video_Generation_Empowerly_Partnership.mp4';
import './Home.css';
...
const Home = () => {
    ...
    // Gooey text will handle the animation logic now
            ...
            <section className="hero">
                ...
                <div className="container">
                    ...
                    >
                        ...
                        <div className="flex justify-center items-center w-full mb-8 min-h-[160px] md:min-h-[200px]">
                            <GooeyText
                                texts={["Empower Your Workforce", "Boost Productivity", "Streamline Operations", "with Empowerly"]}
                                morphTime={1.2}
                                cooldownTime={2}
                                className="w-full h-full flex items-center justify-center"
                                textClassName="font-['Outfit'] gradient-text font-black text-[40px] sm:text-[60px] md:text-[80px] leading-tight px-4 tracking-tight"
                            />
                        </div>
                        ...
                        <motion.div
                            className="w-full mt-10 max-w-4xl mx-auto rounded-2xl overflow-hidden shadow-2xl shadow-indigo-500/20 border border-white/10"
