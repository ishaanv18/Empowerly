...
public class MeetingService {
    ...
    public MeetingResponse createMeeting(CreateMeetingRequest request, String hostId) {
        ...
        auditLogService.logAction(
                ...
                "MEETING",
                meeting.getId(),
                "Meeting scheduled: " + meeting.getTitle(),
                Map.of("scheduledTime", meeting.getScheduledTime().toString(), "duration", meeting.getDuration()),
                null,
                null);
    ...
    public void joinMeeting(String meetingId, String userId) {
        ...
        auditLogService.logAction(
                ...
                "MEETING",
                meetingId,
                "Joined meeting: " + meeting.getTitle(),
                null,
                null,
                null);
    }
    ...
    public void endMeeting(String meetingId, String hostId) {
        ...
        auditLogService.logAction(
                ...
                Map.of("duration", meeting.getDuration()),
                null,
                null);
    }
