...
public class PerformanceReviewService {
    ...
    public ReviewCycleResponse publishCycle(String cycleId) {
        ...
        auditLogService.logAction(
                "HR", // Assuming HR context
                "CYCLE_PUBLISH",
                "REVIEW_CYCLE",
                cycle.getId(),
                "Performance review cycle published: " + cycle.getName(),
                null,
                null,
                null);
    ...
    public ReviewCycleResponse extendDeadline(String cycleId, Integer minutes) {
        ...
        auditLogService.logAction(
                ...
                "REVIEW_CYCLE",
                cycle.getId(),
                "Deadline extended for cycle: " + cycle.getName(),
                Map.of("minutes", extensionMinutes, "newEndDate", cycle.getEndDate().toString()),
                null,
                null);
    ...
    public PerformanceReviewResponse submitSelfAssessment(EmployeeSelfAssessmentRequest request, String employeeId) {
        ...
        auditLogService.logAction(
                ...
                Map.of("cycleId", request.getCycleId()),
                null,
                null);
    ...
    public PerformanceReviewResponse evaluateReview(String reviewId, HRReviewRequest request) {
        ...
        auditLogService.logAction(
                ...
                "PERFORMANCE_REVIEW",
                review.getId(),
                "Performance review evaluated for employee ID: " + review.getEmployeeId(),
                Map.of("finalScore", review.getFinalScore()),
                null,
                null);
    ...
    public PerformanceReviewResponse approveReview(String reviewId) {
        ...
        auditLogService.logAction(
                ...
                "PERFORMANCE_REVIEW",
                review.getId(),
                "Performance review approved for employee ID: " + review.getEmployeeId(),
                null,
                null,
                null);
    ...
    public PerformanceReviewResponse rejectReview(String reviewId) {
        ...
        auditLogService.logAction(
                ...
                "PERFORMANCE_REVIEW",
                review.getId(),
                "Performance review rejected for employee ID: " + review.getEmployeeId(),
                null,
                null,
                null);
