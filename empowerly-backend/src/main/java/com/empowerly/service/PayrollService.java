...
public class PayrollService {
    ...
    public PayrollResponse createPayroll(CreatePayrollRequest request, String hrUserId) {
        ...
        auditLogService.logAction(
                ...
                "PAYROLL",
                payroll.getId(),
                "Payroll drafted for " + request.getMonth() + "/" + request.getYear(),
                Map.of("month", request.getMonth(), "year", request.getYear()),
                null,
                null);
    ...
    public PayrollResponse generatePayrollEntries(String payrollId) {
        ...
        auditLogService.logAction(
                ...
                "PAYROLL",
                payrollId,
                "Payroll entries generated",
                Map.of("totalEmployees", totalEmployees, "totalAmount", totalAmount),
                null,
                null);
    ...
    public PayrollEntryResponse updatePayrollEntry(String entryId, UpdatePayrollEntryRequest request) {
        ...
        auditLogService.logAction(
                "HR", // Since we don't have the user ID here in arguments, assuming HR role context
                      // or update service to pass ID
                "PAYROLL_UPDATE_ENTRY",
                "PAYROLL_ENTRY",
                entry.getId(),
                "Payroll entry updated for " + entry.getEmployeeName(),
                Map.of("netSalary", entry.getNetSalary(), "notes",
    ...
    public PayrollResponse approvePayroll(String payrollId, String adminId, ApprovePayrollRequest request) {
        ...
        auditLogService.logAction(
                ...
                payroll.getId(),
                "Payroll approved",
                Map.of("totalAmount", payroll.getTotalAmount()),
                null,
                null);
    ...
    public PayrollResponse rejectPayroll(String payrollId, String adminId, RejectPayrollRequest request) {
        ...
        auditLogService.logAction(
                ...
                payroll.getId(),
                "Payroll rejected",
                Map.of("reason", request.getRejectionReason()),
                null,
                null);
    ...
    public void saveSalaryStructure(SalaryStructure salaryStructure) {
        ...
        auditLogService.logAction(
                ...
                Map.of("basicSalary", salaryStructure.getBasicSalary()),
                null,
                null);
    }
